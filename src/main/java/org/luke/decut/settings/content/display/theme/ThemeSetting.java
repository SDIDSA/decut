package org.luke.decut.settings.content.display.theme;

import org.luke.gui.controls.Font;
import org.luke.gui.controls.SplineInterpolator;
import org.luke.gui.controls.input.radio.KeyedRadio;
...
public class ThemeSetting extends VBox implements Styleable {
	...
	public ThemeSetting(Settings settings) {
		...
		ThemeButton useThisColor = new ThemeButton(settings.getWindow(), "done", "use_this_color", Direction.DOWN, 0, 20);

		HBox action = new HBox(15, useThisColor, backToMore);
		action.setAlignment(Pos.CENTER_RIGHT);

		KeyedText text = new KeyedText(settings.getWindow(), "text_preview", new Font(16));
