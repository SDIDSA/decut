...
public class ColoredText extends Text implements Styleable {
    private final Window window;
    private StyledColor fill;

    public ColoredText(Window window, String key, Font font, StyledColor fill) {
        super(key, font);
        this.window = window;
        this.fill = fill;
    ...
    public ColoredText(Window window, String key, StyledColor fill) {
