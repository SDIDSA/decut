 ...
 * @author SDIDSA
 */
public class KeyedLabel extends Label implements Localized, KeyedTextNode {
	 ...
	 */
	public KeyedLabel(Window window, String key, Font font) {
		super(null, font);
		this.window = window;
		this.key = key;
	 ...
	 * @param key    The localization key for the label text.
	 */
	public KeyedLabel(Window window, String key) {
