 ...
 * @author SDIDSA
 */
public class KeyedText extends Text implements Localized, KeyedTextNode {
	 ...
	 */
	public KeyedText(Window window, String key, Font font) {
		super(null, font);
		this.window = window;
		this.key = key;
	 ...
	 * @param key    The localization key for the label text.
	 */
	public KeyedText(Window window, String key) {
