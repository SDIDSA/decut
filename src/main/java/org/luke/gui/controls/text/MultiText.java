...
import org.luke.gui.controls.text.keyed.KeyedLink;
import org.luke.gui.controls.text.keyed.KeyedTextNode;
...
import org.luke.gui.controls.text.unkeyed.TextNode;
...
public class MultiText extends TextFlow {
	...
	public void setKey(int index, String key) {
		if (textNodes.get(index) instanceof KeyedTextNode node) {
			...
			throw new IllegalArgumentException("the node at " + index + " is not a KeyedTextNode");
		}
	}

	public void setText(int index, String text) {
		if (textNodes.get(index) instanceof TextNode node) {
			node.setText(text);
		} else {
			throw new IllegalArgumentException("the node at " + index + " is not a textNode");
		}
	}
	...
	public void addLabel(String key, Font font) {
		addTextNode(new KeyedText(window, key, font));
	}
