...
public class ColoredKeyedText extends KeyedText implements Styleable {
    private StyledColor fill;

    public ColoredKeyedText(Window window, String key, Font font, StyledColor fill) {
        super(window, key, font);
        this.fill = fill;
        applyStyle(window.getStyl());
    }

    public ColoredKeyedText(Window window, String key, StyledColor fill) {
