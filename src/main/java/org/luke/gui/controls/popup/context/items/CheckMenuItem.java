...
public class CheckMenuItem extends KeyedMenuItem {
	 ...
	 */
	public CheckMenuItem(ContextMenu menu, String key, String icon, Color fill) {
	...
	public CheckMenuItem(ContextMenu menu, String key, String icon) {
		this(menu, key, icon, null);
	}

	public CheckMenuItem(ContextMenu menu, String key) {
