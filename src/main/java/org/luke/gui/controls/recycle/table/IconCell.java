...
public class IconCell<S> extends StackPane implements TypedTableCell<S, Image>{
    private final Function<S, Image> extractor;
    private final ColorIcon icon;
    private final TableView<S> tableView;

    public IconCell(TableView<S> tableView, Function<S, Image> extractor) {
        super();
    ...
    public void applyTyped(Image extracted) {
        icon.setImage(extracted, tableView.rowHeightProperty().multiply(0.5));
    }
