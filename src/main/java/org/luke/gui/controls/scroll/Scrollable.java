...
public class Scrollable extends StackPane {
    ...
    public void setClipToBounds(boolean val) {
        contentCont.setClip(val ? clip : null);
    }

    public double getScrollY() {
        return -contentCont.getTranslateY();
    }

    public double getScrollX() {
        return -contentCont.getTranslateX();
    }

    public DoubleBinding scrollXProperty() {
        return contentCont.translateXProperty().negate();
    }
