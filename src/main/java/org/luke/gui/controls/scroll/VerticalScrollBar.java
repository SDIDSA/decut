 ...
 * @author SDIDSA
 */
public class VerticalScrollBar extends StackPane {
	 ...
	 */
	public VerticalScrollBar(double width, double padding) {
...
//		});
		...
		visibleProperty().bind(thumb.heightProperty().lessThan(track.heightProperty()).and(show));

		WeakReference<Region> weakChild = new WeakReference<>(child);
		WeakReference<Region> weakParent = new WeakReference<>(parent);
		WeakReference<VerticalScrollBar> weakThis = new WeakReference<>(this);
