...
public class Style {
	...
	public static Color interpolateColor(Color from, Color to, double progress) {
		double red = from.getRed() + progress * (to.getRed() - from.getRed());
		double green = from.getGreen() + progress * (to.getGreen() - from.getGreen());
		double blue = from.getBlue() + progress * (to.getBlue() - from.getBlue());
		double alpha = from.getOpacity() + progress * (to.getOpacity() - from.getOpacity());
