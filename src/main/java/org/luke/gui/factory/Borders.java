...
public class Borders {
	...
	public static Border make(Paint fill, StrokeType type, CornerRadii radius, BorderWidths width) {
		return new Border(new BorderStroke(fill, new BorderStrokeStyle(
				type, StrokeLineJoin.MITER, StrokeLineCap.BUTT, 10, 0, null), radius, width));
	}
	...
	public static Border make(Paint fill, StrokeType type, CornerRadii radius) {
		return make(fill, type, radius, null);
	}
	public static Border make(Paint fill, StrokeType type, double radius, int width) {
		return make(fill, type, new CornerRadii(radius), new BorderWidths(width));
	}
